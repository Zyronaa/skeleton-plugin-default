# {{orgorig}} {{projectorig}} Zyronaa Plugin
...
## Installation
Install the plugin into your server from the [Zyronaa Hub](https://hub.zyronaa.net/{{orgorig}}/{{projectorig}}): `zfpm install {{orgorig}}/{{projectorig}}`
